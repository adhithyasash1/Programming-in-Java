/*
Write a Java program that accepts list of student objects and updates the regular fees,
...
-> A private inner class Regular that implements the interface Generatable and
	overrides method public void feeGenerate (Student s) that, in turn, initializes 
	the regular student fee as 1500.
-> A private inner class Supple that implements the interface Generatable and overrides 
	method public void feeGenerate (Student s) that, in turn, has the following functionality.
